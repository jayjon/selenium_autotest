...
/**
 * @author Young
 * @description 登录的时候不输入密码，只输入用户名，点击登录提示：Web Tours Error - Incorrect username
 */

public class LoginPage_003_LoginWithoutusername extends BaseParpare {
	/*//@Test(dataProvider = "testData")
	public void loginWithoutusername(Map<String, String> data) {
		// 等待登录页面加载
